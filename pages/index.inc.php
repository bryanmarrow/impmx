      ...
      <section id="sede" class="container py-5">
        <div class="row mt-lg-3 pt-1 pt-md-4 pt-lg-5">
          <div class="col-xl-3 col-md-4 text-center text-md-start">
            <h3 class="h4">Sede</h3>
            <h2 class="h1 mb-4">Centro de Convenciones William O. Jenkins</h2>
        ...
        <div class="row mb-lg-3 pb-1 pb-md-4 pb-lg-5 mt-4 mt-sm-n5">
          <div class="col-lg-4 col-md-5 offset-md-6 offset-lg-7 mt-md-n5">
            <div class="gallery mt-md-n4 mx-auto" style="max-width: 416px;">
              <a href="https://goo.gl/maps/ADygF4NRLeVaRQHu9" target="_blank" data-iframe="true" class="gallery-item rounded-2" >
                <img src="assets/img/mapa_centrodeconvenciones_impmx2023.png" class="d-dark-mode-none" alt="Map preview">
                <div class="gallery-item-caption fs-sm fw-medium">Centro de Convenciones William O. Jenkins, Puebla, México</div>
              </a>
            </div>
          </div>
        </div>
